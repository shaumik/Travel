...
$(document).ready(function(){
	...
	function onSuccess(pos){
		param = {latidute: pos.coords.latitude, longitude: pos.coords.longitude}
		$.ajax({
			type: 'POST',
			url: '/',
	...
	function getLocation(){
		if(navigation.geolocation()){
			navigator.geolocation.getCurrentPosition(
				onSuccess,
				onError,
				{enableHighAccuracy:true, timeout:20000,maximumAge:25000}
			);
		}else{
			alert("Location not supported by the browser");
		}
	}
})
;
